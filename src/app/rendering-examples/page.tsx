    ...
    <div className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold mb-3">Cara Menguji Perbedaannya:</h3>
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
            <li>Buka <strong>DevTools</strong> (F12) → Tab <strong>Network</strong></li>
            <li>Kunjungi masing-masing halaman (SSR, SSG, CSR)</li>
            <li>Perhatikan:
              <ul className="list-disc list-inside ml-6 mt-1 space-y-1">
                <li><strong>SSR:</strong> API call terjadi saat page load (di server)</li>
                <li><strong>SSG:</strong> Tidak ada API call (data sudah di HTML)</li>
                <li><strong>CSR:</strong> API call terjadi setelah JavaScript load (di browser)</li>
              </ul>
            </li>
            <li>Lihat <strong>View Page Source</strong> untuk melihat HTML yang dikirim</li>
          </ol>
        </div>
      </div>
    </div>
